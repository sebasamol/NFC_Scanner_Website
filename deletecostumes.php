...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "DELETE FROM costumes WHERE id = ?";
...
<body>
    <div class="editform">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5 mb-3">Usuwanie stroju z bazy</h2>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            <input type="hidden" name="id" value="<?php echo trim($_GET["id"]); ?>"/>
                            <p>Czy na pewno chcesz usunąć strój?</p>
                            <p>
                                <input type="submit" value="Tak" class="btn btn-danger">
                                <a href="clients.php" class="btn btn-secondary">Nie</a>
                            </p>
                        </div>
                    </form>
                </div>
